    ...
    return(
        <div>
            ...
            <form onSubmit={submitHandler}>
                ...
                <div>
                    <label>Course</label>
                    <input value={course_name} onChange={(e)=>setCourse_name(e.target.value)} type="text" />
                </div>

                <div>
                    <label>Instructor</label>
                    <input valueasnumber={instructor} onChange={(e)=>setInstructor(e.target.value)} type="text" />
                </div>

                <div>
                    <label>Course Level</label>
                    <select value={course_level} onChange={(e)=>setCourse_level(e.target.value)} name="course_level">
                ...
                <div>
                    ...
                    <input value={enroll_by} onChange={(e)=>setEnroll_by(e.target.value)} type="text" />
                </div>

                <div>
                    <label>Start Date</label>
                    <input value={starts_at} onChange={(e)=>setStarts_at(e.target.value)} type="text" />
                </div>
                
                <div>
                    <label>Webinar?</label>
                    <input checked={is_webinar} onChange={(e)=>setIs_webinar(e.target.checked)} type="checkbox" />
                </div>
